...
function FAQs() {
    return (
        <>
            ...
            <p>You should be able to use a normal bath, preferably one with handles, by using a shower seat. First of all, place the shower seat close to and parallel with the bath, making sure the seat is at least as high as the top of the bath. Sit on the seat with your leg between the seat and the side of the bath. Swing your leg into the bath and place it on the bottom of the bath. Then take hold of each handle and swing yourself into the bath with a quarter turn left or right as preferred. If you have a left leg you will probably find it easier to have the taps on your right and swing to face them, or with a right leg have the taps to the right. When in the bath be careful not to slip towards your amputated side, and here the handles will come in useful. To get out of the bath, just do this in reverse. It is easier to do than to explain.</p>
            ...
            You must have a chair (not a stool) in the shower into which you transfer from the zimmer frame. The chair should not be able to slide around the shower. Take your shower whilst sitting in the chair, dry yourself after showering and whilst still in the chair, and then transfer back to the zimmer frame and leave the shower.
