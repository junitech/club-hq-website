...
function PhantomPain() {
    return (
        <>
            ...
            <p>Author: Dr Dominic Aldington FRCA FFPMRCA</p>
            <p>has specialised exclusively in pain management for the last 10 years and lectured on the subject around the world. He is the Clinical Lead and Consultant in Pain Medicine at Winchester Hospital and Hampshire Hospitals NHS Trust. Having previously served in the Royal Army Medical Corps for 20 years, his many appointments include Chairman of the UK Armed Forces Clinical Forum, Vice-chairman of the IASP Special Interest Group on the Pain of Torture, Organised Violence and War, and the Surgeon General's Advisor of Veterans' Health and is involved in the development of pain clinics for military veterans.</p>

            <p>I've been invited to write a few words on the subject of pain for your group. However, before I do I would like to start by saying what a great project I think this is and how honored I am to have been invited to participate.</p>
            ...
            <p>One of the many problems with pain is that we are led to believe that it always indicates damage and that the damage and the pain perceived are in some way proportional to one another. Thus, if you have big pain you must have big damage and vice a versa. Unfortunately, this is a fallacy and you can have dreadful pain and little damage, and you can have dreadful damage and little pain. In either way, if we are treating pain, then pain is real whenever anyone says it is.</p>
            ...
            <p>I would suggest the first thing to do with the pain it's understand what it means to you. If you believe it indicates something terrible going on, then you will need to have it investigated and treated invasively. Sadly, this may not change the pain and can even make it worse. If you accept the pain is there, it is real, but it does not indicate anything dreadful happening, then you are more likely to be able to engage in symptom management and master your pain.</p>

            <p>It is probably fair to say that the longer one has a pain the more significant the emotional component becomes. Broadly speaking, the emotional component is made up of anxiety, unhappiness, and frustration (known by many of my patients as the “F' in pain”).</p>
            ...
            <p>For the physical components of pain there are a number of creams and gels, and pills and potions that can be taken but none of these are wonderful for everyone and very often for some people they cause more trouble than they're worth.</p>
