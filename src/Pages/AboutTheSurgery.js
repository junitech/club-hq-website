    ...
    return (
        <>
            ...
            <div className="card mb-3" >
                <div className="row g-0">
                    <div className="col-md-4">
                        <img src="/images/classic-hindquarter-amputation.jpg" class="img-fluid rounded-start" alt="Classic hindquarter amputation"></img>
                    </div>
                    <div className="col-md-8">
                        <div className="card-body">
                            <h6 className="card-title">Fig 1. Classic hindquarter amputation</h6>
                            <p className="card-text">In it's real sense, a hindquarter amputation is any amputation which involves the hind (rear in an animal, lower in a human) quarter of the body and thus it involves an amputation that involves part or all of one side of the pelvis. That is why it is sometimes known as a hemipelvectomy (literally cutting of half of the pelvis). The diagram below shows what a complete (ie all of the hemipelvis) operation would like based on the bones of the pelvis.</p>
            ...
            <div className="card mb-3" >
                <div className="row g-0">
                    <div className="col-md-4">
                        <img src="/images/internal-hemipelvectomy.jpg" class="img-fluid rounded-start" alt="An internal hemipelvectomy"></img>
                    </div>
                    <div className="col-md-8">
                        <div className="card-body">
                            <h6 className="card-text">Fig 2. An internal hemipelvectomy</h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="card mb-3" >
                <div className="row g-0">
                    <div className="col-md-4">
                        <img src="/images/bones-of-the-pelvis.jpg" class="img-fluid rounded-start" alt="Bones of the pelvis"></img>
                    </div>
                    <div className="col-md-8">
                        <div className="card-body">
                            <h6 className="card-text">Fig 3. Bones of the pelvis</h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="card mb-3" >
                <div className="row g-0">
                    <div className="col-md-4">
                        <img src="/images/posterior-flap-hindquarter-amputation-appearance.jpg" class="img-fluid rounded-start" alt="Posterior flap hindquarter amputation appearance"></img>
                    </div>
                    <div className="col-md-8">
                        <div className="card-body">
                            <h6 className="card-text">Fig 4a. Posterior flap hindquarter amputation appearance</h6>
                        </div>
                    </div>
                </div>
            </div>
            <div className="card mb-3" >
                <div className="row g-0">
                    <div className="col-md-4">
                        <img src="/images/anterior-flap-hindquarter-seen-from-back.jpg" class="img-fluid rounded-start" alt="Anterior flap hindquarter (seen from the back)"></img>
                    </div>
                    <div className="col-md-8">
                        <div className="card-body">
                            <h6 className="card-text">Fig 4b. Anterior flap hindquarter (seen from the back)</h6>
                        </div>
                    </div>
                </div>
            </div>
