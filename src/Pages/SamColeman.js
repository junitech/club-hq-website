...
function SamColeman() {
    return (
        <>
            ...
            <img src="/images/sam-coleman.jpg" class="member-photo align-left" alt="Sam Coleman" />
            ...
            <p>In August that year I was given a femoral replacement and was only the 20th person to have that operation. I had at least 80 staples from the hip to under the knee to join the skin together and had to learn to walk  again.</p>
            ...
            <p>After a few family setbacks, on my 3 monthly follow-up chest X-ray, it was discovered that I had metastasis in one of my lungs, one set of which was changing. I was referred to a fabulous surgeon at Birmingham Heartlands hospital who removed them with keyhole surgery. It was very painful to begin with but after a few days I felt fine! Then sadly in 2013 I had metastases in the other lung. The same surgeon removed them again and thankfully (touch wood) I have been ok since !!</p>

            <p>Life isn't easy, it's often frustrating, but I am alive! I have been lucky enough to see my beautiful boys growing up. The youngest is 15 now and I'm thankful for every second I've spent with them - even when they've been naughty!!  At least I have three excellent working limbs and I can drive, I have a nice car, and I am still independent. In 2016 I began working as a reception volunteer at my local hospice and I have found it makes me feel that I'm doing something very worthwhile. Helping and dealing with the families of patients has stopped me feeling a bit sorry for myself, which is a good thing!</p>
